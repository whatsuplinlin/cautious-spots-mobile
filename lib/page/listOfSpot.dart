...
class _MyListState extends State<MyList> {
  Query dbRef = FirebaseDatabase.instance.ref().child('Spot');
  DatabaseReference reference = FirebaseDatabase.instance.ref().child('Spot');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("Cautious Spots"),
